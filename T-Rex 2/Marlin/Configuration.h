...
#define LED_ON_OFF  //LED M225_ON    M224_OFF
//============================= Bed Auto Leveling ===========================
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,800,96}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {150, 150, 2, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {500,800,400,4000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
...
#define EXTRUDER_OFFSET_X {0.0, 33.5} // (in mm) for each extruder, offset of the hotend on the X axis
