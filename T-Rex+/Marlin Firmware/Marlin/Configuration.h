...
#define ENABLE_AUTO_BED_LEVELING // Delete the comment to enable (remove // at the start of the line)
  ...
  #define RIGHT_PROBE_BED_POSITION 363
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,400,96}  // default steps per unit for Ultimaker
...
#define EXTRUDER_OFFSET_X {0.0, -34.0} // (in mm) for each extruder, offset of the hotend on the X axis
